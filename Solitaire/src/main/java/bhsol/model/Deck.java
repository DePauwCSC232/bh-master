...
public class Deck
{
    ...
    * likely. Uses the
    * <a href="http://en.wikipedia.org/wiki/Fisher-Yates_shuffle">Fisher-Yates
    * algorithm</a>
    */
   public void shuffle()
   {
   ...
   /**
    * Look at the topmost (most recently added) card of this deck. If this deck
    * is empty, throws {@link EmptyStackException}.
    * 
    * @return the top card
    */
   public Card getTop()
